...
export default function CategoriesNavbar({ categories = [] }: CategoriesNavbarProps) {
	...
	return (
		<aside className="sticky top-0 z-30 -mx-4 w-[calc(100%+2rem)] self-start bg-[var(--surface-muted)/.96] text-(--ink) backdrop-blur sm:-mx-6 sm:w-[calc(100%+3rem)] lg:top-24 lg:mx-0 lg:w-60 lg:border-0 lg:bg-transparent lg:p-0 lg:backdrop-blur-0">
