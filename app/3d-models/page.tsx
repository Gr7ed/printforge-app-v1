...
export default async function ModelsPage({ searchParams } : ModelsPageProps): Promise<JSX.Element> {
    ...
    return (
        <>
        <div className="sticky top-18 z-20 flex flex-col gap-4 border-b border-[#ded9d0] bg-[#f7f5f0] pb-4 pt-5 sm:pb-5 sm:pt-6 lg:flex-row lg:items-end lg:justify-between lg:gap-6">
