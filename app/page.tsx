...
export default function Home() {
  return (
    <main className="w-full px-4 py-6 sm:px-8 sm:py-8">
      <section className="mx-auto grid min-h-[calc(100vh-4rem)] w-full max-w-6xl items-center gap-10 md:grid-cols-2 md:gap-[clamp(3rem,8vw,7rem)]" aria-labelledby="hero-title">
        <div className="flex flex-col items-start gap-4">
          <span className="text-sm font-semibold leading-6 text-gray-600">Your go-to platform for 3D printing files</span>
          <h1 id="hero-title" className="m-0 max-w-136 text-[clamp(2rem,9vw,4rem)] leading-tight">Discover what&apos;s possible with 3D printing</h1>
          ...
          <button
              className="border-2 border-black bg-white px-6 py-3 font-semibold text-black transition duration-100 hover:bg-black hover:text-white"
          >
          Browse models
          </button>
        </div>
